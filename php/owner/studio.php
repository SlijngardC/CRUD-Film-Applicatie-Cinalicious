...
if(isset($_POST['submit'])) {
  ...
  if ($current_password == $password) {
    ...
    $sql = "INSERT INTO studios(name,country) values('$name','$country')";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/owner/studio.css">
...
<div class="main">
        ...
        <div class="studcontainer"> 
          <form  action="" method="POST">
               <h1>Enter Studio details</h1>
              <input type="text" class="form-control" placeholder="name" name="name" required><br>
               <input type="text" class="form-contry" placeholder="country" name="country" required>
               <br>
