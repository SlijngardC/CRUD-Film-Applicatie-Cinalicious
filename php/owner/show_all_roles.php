...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/owner/show_all_roles.css">
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<tr class="tblrcolor">
                    ...
                    <td>' . $type . '</td>
                    <td>
                    <a href="role_update.php? updateid='.$id.'"><button class="upd">Update</button></a>
                    <a href="role_delete.php? deleteid='.$id.'"><button class="del">Delete</button></a>
                    </td>
                  </tr>';
        }
    } else {
