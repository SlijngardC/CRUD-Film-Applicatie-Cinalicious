...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/admin/show_all_genres.css">
    ...
    if ($result) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr class="tblrcolor">
                ...
                <td>
                <a href="genre_update.php? updateid='.$id.'"><button class="upd">Update</button></a>
                <a href="genre_delete.php? deleteid='.$id.'"><button class="del">Delete</button></a>
                </td>
              </tr>';
    }
    } else {
