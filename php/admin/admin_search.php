...
<html lang="en">
  <head>
    ...
    <link rel='stylesheet' href='../../css/admin/admin_search.css'>
...
<div class="main">
  ...
  if (mysqli_num_rows($result) > 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<img src='../../posters/" . $row['poster'] . "' height='250' width='200' style='margin-top: 30px;margin-left:30px;margin-right:20px;' />";
