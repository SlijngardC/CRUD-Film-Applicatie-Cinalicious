...
<div class="main">
  <section class="bghome">
   <div class="container">
     <img class="lgo" src="../../img/Icons/cinalicious_admin.png" alt="">
   </div>
   
   <div class="srch">
  <form action="admin_search.php" method="POST" class="schr">
 ...
 <div class="welcontainer">
  <h1>WELCOME ADMIN<img class='gearow' src='../../img/Icons/admin_gear.png'></h1>
  <p>
<?php if (isset($_SESSION["email"])) {
 ...
 <div class="jumbotron">
          ...
          <?php
            include 'admin_latest-fetcher.php';
           ?>
...
<div class="foootercontainer">
  ...
  <div class="footerbottom">
    <p>@2023 Slijngard Chivar, Tushar Gena & Sahil Bisai | All Rights Reserved <img src="../../img/Icons/Icon3.png" alt="" class="CC"></p>
  </div>
</div>
</footer>
