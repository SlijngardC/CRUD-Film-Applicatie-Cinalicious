...
if(isset($_POST['submit'])) {
  ...
  if ($current_password == $password) {
    ...
    $sql = "INSERT INTO directors(name,bio) values('$name','$bio')";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/admin/directors.css">
...
<a class="logout" href="logout.php">LogOut</a>
  ...
  <div class="main">
    ...
    <h1> Enter Director details</h1>
    
    <input type="text" class="form-control" placeholder="name" name="name" required><br>
    <textarea type="text" class="form-bio" placeholder="bio" name="bio" required></textarea>
    <br>
